    ...
    return (
      <div className="glass mx-auto mt-10 max-w-md rounded-2xl p-6 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Your organisation title doesn't allow you to export data. Ask an administrator to update
          it.
        </p>
      </div>
    );
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground">
        Take your hiring data with you whenever you need a simple CSV snapshot.
      </p>
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div className="glass rounded-2xl p-6">
          <h3 className="font-display text-lg font-semibold">Candidates</h3>
          <p className="mt-1 text-sm text-muted-foreground">
            Every candidate with stage, source, position, and timestamps.
          </p>
          <button
            onClick={exportCands}
            className="btn-teal mt-4 inline-flex items-center gap-1.5 rounded-xl px-4 py-2 text-sm font-semibold"
          >
        ...
        <div className="glass rounded-2xl p-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Open roles with status, hiring manager, and start dates.
          </p>
          <button
            onClick={exportReqs}
            className="btn-teal mt-4 inline-flex items-center gap-1.5 rounded-xl px-4 py-2 text-sm font-semibold"

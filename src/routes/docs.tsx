      ...
      <article className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-16">
        <div className="glass rounded-3xl p-6 sm:p-10 prose prose-slate max-w-none">
          ...
          <ol>
            ...
            <li>Use the <strong>Pipeline</strong> board to filter candidates by position or source, add candidates, and move them through Applied, Screen, Interview, Offer, Hired, and Rejected.</li>
          ...
          <ul>
            ...
            <li>Pipeline drag-and-drop is designed for desktop. On touch devices, use the stage selector on the candidate record.</li>
